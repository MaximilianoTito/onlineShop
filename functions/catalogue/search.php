...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $query = "SELECT * FROM catalogue WHERE name LIKE '%$search%' AND status=true";
...
<div class="container text-center pt-1">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li><a href="/onlineShop/views/auth/logged.php"><span style="padding-left: 15px; ">Mostrar todo</span> </a></li>
        </ol>
    </nav>
</div>
<div class="p-2">
