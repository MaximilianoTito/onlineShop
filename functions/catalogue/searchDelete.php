...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $query = "SELECT * FROM catalogue WHERE name LIKE '%$search%' AND status=false";
    $result = mysqli_query($conn, $query);
?>
<div class="container text-center">
    <div class="row align-items-center m-2">
        <div class="col">
            <form action="/onlineShop/functions/catalogue/searchDelete.php" method="get">
                <div class="col-sm-8">
...
<div class="container text-center pt-1">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/onlineShop/views/auth/logged.php"><span style="color: green;">Activos</span></a></li>
            <li><a href="/onlineShop/functions/catalogue/trash.php"><span style="padding-left: 15px;">Mostrar todo</span></a></li>
        </ol>
    </nav>
</div>
<div class="p-2">
        ...
        <table class="table table-hover table-secondary table-sm">
            ...
            <tbody>
                ...
                <tr style="font-size: 14px;">
                    ...
                    <td>
                        <a href="/onlineShop/functions/catalogue/activate.php?id=<?php echo $row["id"] ?>">
